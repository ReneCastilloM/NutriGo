...
public class Ingresar_paciente_enviar {
    ...
    public void enviar() throws SQLException
    {
        ...
        String sql_2 = "INSERT INTO pacientes_info VALUES(NULL," + peso + "," + estatura + "," + c_cintura + "," + c_cadera + "," +
                c_cadera + "," + c_brazo + "," + biceps + "," + triceps + "," + subescupular + "," + ileocrestal + "," + suprailiaco +
                "," + hemoglobina + "," + hematrocitos + "," + linfocitos + "," + glucosa + "," + urea + "," + a_u + "," + creatonina +
                "," + trigliceridos + "," + colesterol + "," + albumina + "," + sodio + "," + potasio + ")";
        String sql_3 = "INSERT INTO pacientes_clinico VALUES(NULL," + edema + "," + obesidad + "," + unas1 + "," + unas2 + "," +
                ...
                "," + piel5 + "," + piel6 + "," + piel7 + "," + esqueleto1 + "," + esqueleto2 + "," + esqueleto3 + "," + gastro1 + ")";
        String sql_4 = "INSERT INTO pacientes_evaluacion VALUES(NULL,'" + hora1 + "','" + lugar1 + "','" + alimento1 + "','" + ingredientes1 + "','" +
        hora2 + "','" + lugar2 + "','" + alimento2 + "','" + ingredientes2 + "','" + hora3 + "','" + lugar3 + "','" + alimento3 + "','" + ingredientes3 + "','" +
        hora4 + "','" + lugar4 + "','" + alimento4 + "','" + ingredientes4 + "','" + hora5 + "','" + lugar5 + "','" + alimento5 + "','" + ingredientes5 + "','" +
        hora6 + "','" + lugar6 + "','" + alimento6 + "','" + ingredientes6 + "')";
